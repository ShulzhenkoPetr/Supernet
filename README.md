...
Ввиду ограниченности вычислительных ресурсов, ограничимся рассмотрением предельных случаев для проверки зависимости между результатами совместно обученных моделей и их standalone версий. 
